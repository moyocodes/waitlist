  ...
  try {
    const response = await axios.post(
      "https://api.resend.com/emails",
      {
        ...
        html: `
          <div style="font-family:'Helvetica Neue',Arial,sans-serif;background:#faf9f6;padding:40px;text-align:center;color:#222;">
            
            <!-- LOGO -->
            <div style="margin-bottom:20px;">
              <img src="https://waitlist-bay-kappa.vercel.app/logo.png" alt="Yagso Logo" style="max-width:110px;" />
              <div style="height:3px;width:60px;background:linear-gradient(90deg,#d4af37,#b8860b);margin:12px auto;border-radius:2px;"></div>
            </div>

            <!-- JEWELRY IMAGE -->
            <div style="margin-bottom:25px;">
              <img src="https://waitlist-bay-kappa.vercel.app/mo.png" alt="Jewelry" 
                style="max-width:100%;border-radius:14px;box-shadow:0 6px 18px rgba(0,0,0,0.12);" />
            </div>

            <!-- CARD -->
            <div style="background:#fff;border-radius:16px;padding:35px 25px;max-width:560px;margin:0 auto;
                        box-shadow:0 8px 24px rgba(212,175,55,0.25);border:1px solid #f2e6b3;">
