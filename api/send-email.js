  ...
  try {
    ...
    <div style="font-family:'Helvetica Neue',Arial,sans-serif;
        ...
        <div style="max-width:400px;margin:0 auto;text-align:center;">
            ...
            <div style="margin:60px 0;">
                <a href="https://waitlist-bay-kappa.vercel.app/"
                   style="display:inline-block;
                          ...
                          position:relative;
                          overflow:hidden;">
                    <span style="position:relative;z-index:1;">Enter Yagso Collection</span>
                </a>
            ...
            <!-- What's Next Section -->
            <div style="background:rgba(6, 95, 70, 0.03);
                ...
                <div style="display:flex;align-items:flex-start;margin:12px 0;">
                    <span style="color:#065f46;font-size:16px;margin-right:12px;font-weight:bold;">1.</span>
                    <span style="color:#4b5563;font-size:14px;line-height:1.5;">Use your access code to unlock exclusive collections</span>
                </div>
                
                <div style="display:flex;align-items:flex-start;margin:12px 0;">
                    <span style="color:#065f46;font-size:16px;margin-right:12px;font-weight:bold;">2.</span>
                    <span style="color:#4b5563;font-size:14px;line-height:1.5;">Browse our curated luxury jewelry pieces</span>
                </div>
                
                <div style="display:flex;align-items:flex-start;margin:12px 0;">
                    <span style="color:#065f46;font-size:16px;margin-right:12px;font-weight:bold;">3.</span>
                    <span style="color:#4b5563;font-size:14px;line-height:1.5;">Receive priority notifications for new arrivals</span>
                </div>
            </div>
        </div>
        ...
        <div style="text-align:center;
            ...
            <div style="margin-top:20px;">
                <span style="color:#d1d5db;font-size:12px;">Follow us for updates</span>
            </div>
        </div>
    </div>
`,
